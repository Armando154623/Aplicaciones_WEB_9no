...
def obtener_alumnos():
    ...
    estudiantes = []
    archivo = open("Archivos/Estudiantes.prn", mode="r")
    if archivo.readable():
...
def generar_archivo_usuario():
    archivo = open("Archivos/usuarios.txt", mode="w")
...
def autenticar_usuario(usuario, contrasena):
    ...
    if usuario != "":
        archivo = open("Archivos/usuarios.txt", mode="r")
...
autenticar_usuario("18420427", "ejg4#4?GY")
